...
public class InternalSchematic {
    public void New(MapDef m, World w, Location l1, Location l2) throws IOException {
    ...
    public void Load(MapDef m, World w, Location l1, Location l2) throws IOException, DataException, MaxChangedBlocksException {
        File file = new File(m.getArenaName()+ ".schem");
        Vector v = new Vector(l1.getBlockX(), l1.getBlockY(), l1.getBlockZ()); // loc is your location variable.
